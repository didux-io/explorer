...
/*
    Endpoint for client to talk to node about DAO stuff
*/
...
var extraBalanceAddr = "0x807640a13483f8ac783c557fcdf27be11ea4ac7a";
...
module.exports = function(req, res) {
  ...
  if (!("action" in req.body))
    ...
    try {
      ...
      var extraBalance = eth.getBalance(extraBalanceAddr);
      extraBalance = etherUnits.toEther(extraBalance, 'wei');
      var totalSupply = DAO.totalSupply();
